const Routes = [
    ...
    { method: 'post', path: '/Visits/CreatePastVisit', controller: 'Visit', action: 'CreatePastVisit' },
    ...
    { method: 'put', path: '/Visits/CompletePastVisit', controller: 'Visit', action: 'CompletePastVisit' },
