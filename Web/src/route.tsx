...
const AppRouter = () => {
    ...
    const routes: RouteItemType[] = [
        ...
        { path: Paths.Organisation, element: <Organization />, requiredRole: [privileges.reportorganization] },
        { path: Paths.DoctorReport, element: <DoctorReport />, requiredRole: [privileges.reportdoctor] },
