...
import { METHOD_DELETE, METHOD_GET, METHOD_POST, METHOD_PUT, STOCK_CREATE_STOCK, STOCK_DELETE_MOVEMENT, STOCK_DELETE_STOCK, STOCK_GET_LAST_MOVEMENT, STOCK_GET_MOVEMENT, STOCK_GET_STOCK, STOCK_INSERT_STOCK, STOCK_TAG } from "@Constant/api";
import { StockCreateRequest, StockDeleteMovementRequest, StockDeleteRequest, StockInsertRequest, StockItem, StockLastMovementItem, StockListRequestType, StockmovementItem, StockmovementListRequest, StockStockLastMovementRequest, StockUseRequest } from "./type";
...
export const stockQuery = gatewayApi
    ...
    .injectEndpoints({
        endpoints: (builder) => ({
            ...
            getLastMovementStocks: builder.query<StockLastMovementItem[], StockStockLastMovementRequest>({
                query: (body) => ({
                    url: `${STOCK_GET_LAST_MOVEMENT}/${body.WarehouseID}`,
                    method: METHOD_GET,
                }),
                providesTags: [STOCK_TAG],
            }),
