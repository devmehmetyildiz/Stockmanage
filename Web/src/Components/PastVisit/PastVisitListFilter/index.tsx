...
import { VISIT_STATU_COMPLETED, VISIT_STATU_PLANNED, } from '@Constant/index'
...
interface PastVisitListFilterProps {
...
const PastVisitListFilter: React.FC<PastVisitListFilterProps> = ({ reqBody, setReqBody, pageTitle }) => {
    ...
    const requestStatusOptions: DropdownItemProps[] = [
...
export default PastVisitListFilter