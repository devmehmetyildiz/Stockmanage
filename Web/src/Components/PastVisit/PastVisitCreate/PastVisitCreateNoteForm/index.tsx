...
const PastVisitCreateNoteForm: React.FC = () => {

    const { t } = useTranslation()

    const { fields, append, remove } = useFieldArray<VisitCreatePastVisitRequest>({ name: 'Notes' })
...
export default PastVisitCreateNoteForm