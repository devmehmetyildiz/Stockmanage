...
const VisitUpdateDefinesNoteForm: React.FC = () => {

    const { t } = useTranslation()

    const { fields, append, remove } = useFieldArray<VisitUpdateDefinesRequest>({ name: 'Notes' })
...
export default VisitUpdateDefinesNoteForm