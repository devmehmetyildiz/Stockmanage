...
interface CashflowReportListFilterProps {
    reqBody: CashflowGraphRequest
    setReqBody: React.Dispatch<React.SetStateAction<CashflowGraphRequest>>
}

const AppForm = createAppForm<CashflowGraphRequest>()

const CashflowReportListFilter: React.FC<CashflowReportListFilterProps> = ({ reqBody, setReqBody }) => {

    const { t } = useTranslation()
    const [isExpended, setIsExpended] = useState(false)

    const { watch, trigger, getValues, formState } = useFormContext<CashflowGraphRequest>()
...
export default CashflowReportListFilter