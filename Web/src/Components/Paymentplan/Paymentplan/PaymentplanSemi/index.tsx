...
import { VISIT_PAYMENT_STATUS_SEMI, VISIT_TYPE_SALEVISIT, } from '@Constant/index'
...
const PaymentplanSemi: React.FC = () => {
    ...
    const { data, isFetching } = useGetPaymentplansQuery({ isActive: 1, Status: VISIT_PAYMENT_STATUS_SEMI })
    ...
    const TableQuery = useGetTableMetaQuery({ Key: 'paymentplansemi' })
...
export default PaymentplanSemi
