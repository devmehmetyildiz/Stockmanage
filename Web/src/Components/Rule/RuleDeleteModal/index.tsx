import { useDeleteRuleMutation } from '@Api/Rule'
...
const RuleDeleteModal: React.FC<RuleDeleteModalProps> = (props) => {
    ...
    >
        ...
        <Modal.Content image>
            ...
            <Modal.Description>
                ...
                <p>
                    {data?.Name} {t('Pages.Rules.Delete.Label.DeleteCheck')}
                </p>
            </Modal.Description>
        </Modal.Content>
        <Modal.Actions>
                    ...
                    DeleteRule({ Uuid: data?.Uuid })
                        ...
                        .then(() => {
                            ...
                            Pushnotification({
                                ...
                                Description: t('Pages.Rules.Messages.DeleteSuccess')
                            })
                        })
                }
            }} />
