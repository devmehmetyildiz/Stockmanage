...
const FreeVisitCreateNoteForm: React.FC = () => {

    const { t } = useTranslation()

    const { fields, append, remove } = useFieldArray<VisitCreateFreeVisitRequest>({ name: 'Notes' })
...
export default FreeVisitCreateNoteForm